    ...
    t = "undefined" != typeof t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.form = function (t)
    {
        ...
        return a.each(function ()
        {
            ...
            F = {
                initialize: function ()
                {
                    F.get.settings(), d ? (E === i && F.instantiate(), F.invoke(c)) : (E !== i && E.invoke("destroy"), F.verbose("Initializing form validation", O, x), F.bindEvents(), F.set.defaults(), F.instantiate())
                }, instantiate: function ()
                {
                ...
                {
                    F.verbose("Attaching form events"), O.on("submit" + P, F.validate.form).on("blur" + P, k.field, F.event.field.blur).on("click" + P, k.submit, F.submit).on("click" + P, k.reset, F.reset).on("click" + P, k.clear, F.clear), x.keyboardShortcuts && O.on("keydown" + P, k.field, F.event.field.keydown), m.each(function ()
                    {
                ...
                }, removeEvents: function ()
                {
                    ...
                    {
                        var n, i, o, a = F.get.ruleName(e), r = F.get.ancillaryValue(e),
                    ...
                    }, settings: function ()
                    {
                        ...
                        A = x.namespace, w = x.metadata, k = x.selector, S = x.className, T = x.error, R = "module-" + A, P = "." + A, E = O.data(R), F.refresh()
                    }, field: function (t)
                    {
                    ...
                    }, values: function (t)
                    {
                        ...
                        {
                            var i, o = F.get.field(t), a = o.parent(), r = e.isArray(n), s = a.is(k.uiCheckbox),
                    ...
                    {
                        var o = t.identifier || n, a = F.get.field(o), r = !!t.depends && F.get.field(t.depends),
                            s = !0, l = [];
                    ...
                    {
                        var o = F.get.field(t.identifier), a = (n.type, o.val()), r = F.get.ancillaryValue(n),
                            s = F.get.ruleName(n), l = x.rules[s];
    ...
    t = "undefined" != typeof t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.dropdown = function (o)
    {
        ...
        return r.each(function (p)
        {
            var h, v, b, y, x, C, w, k,
                ...
                D = S.selector, q = S.error, j = S.templates, z = "." + F, M = "module-" + F, I = e(this),
                L = e(S.context), N = I.find(D.text), V = I.find(D.search), H = I.find(D.sizer), U = I.find(D.input),
                W = I.find(D.icon), B = I.prev().find(D.text).length > 0 ? I.prev().find(D.text) : I.prev(),
                Q = I.children(D.menu), X = Q.find(D.item), $ = !1, Y = !1, K = !1, Z = this, J = I.data(M);
            k = {
                initialize: function ()
                {
                ...
                {
                    k.verbose("Clearing metadata"), X.removeData(E.text).removeData(E.value), I.removeData(E.defaultText).removeData(E.defaultValue).removeData(E.placeholderText)
                }, toggle: function ()
                {
                ...
                {
                    var n = t !== i ? t : k.get.query(), o = null, a = k.escape.regExp(n),
                        r = new RegExp("^" + a, "igm");
                ...
                }, forceSelection: function ()
                {
                    ...
                    }, input: function (e)
                    {
                        ...
                        click: function (t)
                        {
                            var n = e(this), i = I.find(D.label), o = i.filter("." + T.active),
                        ...
                        keydown: function (e)
                        {
                            ...
                            if (n)
                            {
                                var i = I.find(D.label), o = i.filter("." + T.active),
                    ...
                    }, eventOnElement: function (t, i)
                    {
                        var o = e(t.target), a = o.closest(D.siblingLabel), r = n.body.contains(t.target),
                            s = 0 === I.find(a).length, l = 0 === o.closest(Q).length;
                        return i = e.isFunction(i) ? i : function ()
                        {
                    ...
                    {
                        var e = k.get.value();
                        k.verbose("Saving default value as", e), I.data(E.defaultValue, e)
                    }, defaultText: function ()
                    {
                        var e = k.get.text();
                        k.verbose("Saving default text as", e), I.data(E.defaultText, e)
                    }, placeholderText: function ()
                    {
                        var e;
                        S.placeholder !== !1 && N.hasClass(T.placeholder) && (e = k.get.text(), k.verbose("Saving placeholder text as", e), I.data(E.placeholderText, e))
                ...
                }, scrollPage: function (e, t)
                {
                    ...
                    }, value: function (e, t, n)
                    {
                        ...
                        } else k.verbose("Storing value in metadata", o, U), o !== r && I.data(E.value, s);
                ...
                }, hideAndClear: function ()
                {
                    ...
                    value: function (t)
                    {
                        var n = e.isArray(t), i = "string" == typeof t, o = !i && !n, a = i && t.search(O.quote) !== -1,
                            r = [];
    ...
    t = "undefined" != typeof t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.modal = function (o)
    {
        ...
        return r.each(function ()
        {
            var r, v, b, y, x, C, w, k, S,
                ...
                D = e(this), q = e(T.context), j = D.find(A.close), z = this, M = D.data(O);
            S = {
                initialize: function ()
                {
    ...
    t = "undefined" != typeof t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.popup = function (o)
    {
        ...
        return r.each(function ()
        {
            var r, v, b, y, x, C,
                ...
                j = w.target ? e(w.target) : F, z = 0, M = !1, I = !1, L = this, N = F.data(E);
            C = {
                initialize: function ()
                {
            ...
            f = {
                ...
                }, decrement: function (e)
                {
                    ...
                    }, labelInterval: function ()
                    {
                        ...
                        clearInterval(f.interval), w.one(a + y, t), R = !0, f.interval = setInterval(function ()
                        {
                    ...
                    {
                        e = e || m.text.active, f.debug("Setting active state"), m.showActivity && !f.is.active() && C.addClass(g.active), f.remove.warning(), f.remove.error(), f.remove.success(), e = m.onLabelUpdate("active", e, f.value, f.total), e && f.set.label(e), w.one(a + y, function ()
                        {
                            m.onActive.call(T, f.value, f.total)
                        })
                    }, success: function (e)
                    {
                        e = e || m.text.success || m.text.active, f.debug("Setting success state"), C.addClass(g.success), f.remove.active(), f.remove.warning(), f.remove.error(), f.complete(), m.text.success ? (e = m.onLabelUpdate("success", e, f.value, f.total), f.set.label(e)) : (e = m.onLabelUpdate("active", e, f.value, f.total), f.set.label(e)), w.one(a + y, function ()
                        {
                            m.onSuccess.call(T, f.total)
                        })
                    }, warning: function (e)
                    {
                        e = e || m.text.warning, f.debug("Setting warning state"), C.addClass(g.warning), f.remove.active(), f.remove.success(), f.remove.error(), f.complete(), e = m.onLabelUpdate("warning", e, f.value, f.total), e && f.set.label(e), w.one(a + y, function ()
                        {
                            m.onWarning.call(T, f.value, f.total)
                        })
                    }, error: function (e)
                    {
                        e = e || m.text.error, f.debug("Setting error state"), C.addClass(g.error), f.remove.active(), f.remove.success(), f.remove.warning(), f.complete(), e = m.onLabelUpdate("error", e, f.value, f.total), e && f.set.label(e), w.one(a + y, function ()
                        {
    ...
    t = "undefined" != typeof t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.search = function (o)
    {
        ...
        return e(this).each(function ()
        {
            ...
            m = {
                ...
                {
                    var t, n = S.find(y.result), i = S.find(y.category), o = n.index(n.filter("." + p.active)),
                        a = n.length, r = e.which,
                        s = {backspace: 8, enter: 13, escape: 27, upArrow: 38, downArrow: 40};
                    if (r == s.escape && (m.verbose("Escape key pressed, blurring search field"), m.trigger.blur()), m.is.visible()) if (r == s.enter)
                    {
    ...
    t = "undefined" != typeof t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.sidebar = function (o)
    {
        ...
        return r.each(function ()
        {
            var r, b, y, x, C, w,
                ...
                z = D.children(S.pusher), M = this, I = O.data(F);
            w = {
                initialize: function ()
                {
                ...
                }, scrollTo: function (t)
                {
                    ...
                    content: function (t, n)
                    {
                        var o, a, r = b.get.tabElement(t), s = {
                            ...
                            onSuccess: function (e)
                            {
                                "response" == x.cacheType && b.cache.add(n, e), b.update.content(t, e), t == h ? (b.debug("Content loaded", t), b.activate.tab(t)) : b.debug("Content loaded in background", t), x.onFirstLoad.call(r[0], t, v, y), x.onLoad.call(r[0], t, v, y), "response" != x.cacheType && b.cache.add(n, r.html())
                            },
                            urlData: {tab: n}
    ...
    t = "undefined" != typeof t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.transition = function ()
    {
        ...
        return a.each(function (t)
        {
            ...
            C = {
                initialize: function ()
                {
                    m = C.get.settings.apply(k, c), h = m.className, p = m.error, v = m.metadata, x = "." + m.namespace,
                        y = "module-" + m.namespace, g = w.data(y) || C, b = C.get.animationEndEvent(), f && (f = C.invoke(u)), f === !1 && (C.verbose("Converted arguments into settings object", m), m.interval ? C.delay(m.animate) : C.animate(), C.instantiate())
                }, instantiate: function ()
                {
